# Generated by Django 2.2 on 2020-11-04 22:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifiled_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='HWB.Category', verbose_name='分类')),
                ('tags', models.ManyToManyField(blank=True, to='HWB.Tag', verbose_name='标签')),
                ('tui', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='HWB.Tui', verbose_name='推荐位')),
